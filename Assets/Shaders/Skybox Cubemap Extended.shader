...
Shader "Skybox/Cubemap Extended"
{
	Properties
	{
		...
		_SkyboxOffset("Skybox Offset", Vector) = (0,0,0)
	...
	LOD 0
		...
		Pass
		{
			...
			uniform half3 _SkyboxOffset;
			uniform half4 _FogOffset;
			...
			v2f vert ( appdata v )
			{
				...
				o.ase_texcoord.xyz = vertexToFrag774 + _SkyboxOffset;
				
				o.ase_texcoord1 = v.vertex + _FogOffset;
...
/*ASEBEGIN
Version=17602
1927;1;1906;1020;1318.542;-1269.347;1;True;False
...
ASEEND*/
//CHKSM=874CE7656F08A9877A972CE68562ADF7255F7C2B